		...
		(
			<div
				style={{
					...
					alignItems: "center",
					padding: "2rem",
					background: `linear-gradient(145deg, ${ogTheme.colors.primary} 0%, ${ogTheme.colors.secondary} 100%)`,
					color: ogTheme.colors.foreground,
					position: "relative",
					textAlign: "center",
				}}
			>
				<h1 style={{ fontSize: 72, fontWeight: 800, margin: 0, fontFamily: "Poppins" }}>
					Mingull&apos;s Posts
				</h1>
				<p
					style={{
