...
MDX is a file format that allows you to write JSX in your Markdown files.
This means that you can use React components, import other components,
and even write inline JSX in your Markdown files.
...
## Examples of MDX components

MDX allows you to use any React component in your Markdown files.
This means you can create interactive and dynamic content easily.
You can also import components and use them directly in your Markdown.

## Examples of Counter components
