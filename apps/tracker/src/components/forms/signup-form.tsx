...
import { defineRequirements, AdvancedInput, requirementsToSchema } from "@mingull/ui/comps/advanced-input";
...
export function SignupForm({ className, ...props }: React.ComponentProps<"div">) {
	...
	async function onSubmit(values: z.infer<typeof formSchema>) {
		console.log({ values });
		const { message, success, error } = await signUp({ email: values.email, password: values.password });
