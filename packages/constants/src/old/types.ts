...
export type DefaultsSchema<Schema extends SchemaType, Shared extends unknown = unknown> =
	...
	: Schema extends Record<string, z.ZodTypeAny> ? Prettify<{ readonly [K in keyof Schema]: Readonly<z.infer<Schema[K]>> } & (Shared extends object ? Shared : {})>
	: never;
...
export type LocaleMap<TLocales extends Locales, Schema extends SchemaType, Shared = unknown> = {
	[K in TLocales[number]]: Shared extends object ? Prettify<Omit<DefaultsSchema<Schema>, keyof Shared>> : DefaultsSchema<Schema>;
};
